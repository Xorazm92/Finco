...
let AiAnalysisController = class AiAnalysisController {
    ...
    async analyzeAnswerQuality(dto) {
        return this.aiAnalysisService.analyzeMessagePair(dto.questionId, dto.answerId);
    }
};
...
], AiAnalysisController.prototype, "analyzeAnswerQuality", null);

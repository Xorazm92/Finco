...
export class AutoMigration1747203169456 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('ACCOUNTANT', 'BANK_CLIENT', 'SUPERVISOR', 'ADMIN')`);
        ...
        await queryRunner.query(`CREATE TABLE "message_logs" ("id" SERIAL NOT NULL, "telegram_message_id" bigint NOT NULL, "telegram_chat_id" bigint NOT NULL, "sent_at" TIMESTAMP NOT NULL, "text_preview" character varying(255), "is_question_candidate" boolean NOT NULL DEFAULT false, "replied_to_message_id" bigint, "replied_at" TIMESTAMP, "response_time_seconds" integer, "senderUserId" integer, "replyByUserId" integer, CONSTRAINT "PK_f0aae0d876a96fa1da0a1b97444" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "report_types" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, CONSTRAINT "UQ_f9bfaf722e6cbd5eb9c6dab6f27" UNIQUE ("code"), CONSTRAINT "PK_cf77ff01fa1da1f9978995e67c3" PRIMARY KEY ("id"))`);

...
export class AddCompanyAndKpiEntities1747732607750
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_chat_roles" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "chat_id" bigint NOT NULL, "role" "public"."user_chat_roles_role_enum" NOT NULL DEFAULT 'CLIENT', "assigned_by_user_id" integer, "assigned_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a09624cf71cbb8cb98937ad15fc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "company" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "inn" character varying NOT NULL, "nds_status" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_b140771a1e25f93216cbf663b0d" UNIQUE ("inn"), CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_company_assignment" ("id" SERIAL NOT NULL, "role_in_company" character varying NOT NULL, "salary_percentage_from_company" double precision NOT NULL DEFAULT '100', "user_id" integer, "company_id" integer, CONSTRAINT "PK_e01370303e71f6f5b6818b263a6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."message_logs_senderroleatmoment_enum" AS ENUM('CLIENT', 'ACCOUNTANT', 'BANK_CLIENT', 'SUPERVISOR', 'ADMIN', 'DIRECTOR', 'OTHER_INTERNAL')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."message_logs_status_enum" AS ENUM('PENDING_ANSWER', 'ANSWERED', 'CLOSED_TIMEOUT', 'CLOSED_BY_SUPERVISOR')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."message_logs_replybyroleatmoment_enum" AS ENUM('CLIENT', 'ACCOUNTANT', 'BANK_CLIENT', 'SUPERVISOR', 'ADMIN', 'DIRECTOR', 'OTHER_INTERNAL')`,
    );
    await queryRunner.query(
      `CREATE TABLE "message_logs" ("id" SERIAL NOT NULL, "telegram_message_id" bigint NOT NULL, "telegram_chat_id" bigint NOT NULL, "senderRoleAtMoment" "public"."message_logs_senderroleatmoment_enum", "sent_at" TIMESTAMP NOT NULL, "text_preview" character varying(255), "isClientQuestion" boolean NOT NULL DEFAULT false, "status" "public"."message_logs_status_enum" NOT NULL DEFAULT 'PENDING_ANSWER', "questionKeywords" text, "replied_to_message_id" bigint, "replyByRoleAtMoment" "public"."message_logs_replybyroleatmoment_enum", "replied_at" TIMESTAMP, "response_time_seconds" integer, "replyMessageId" bigint, "replyDetectionMethod" character varying, "confidenceScore" double precision, "potentialReplyToMessageId" integer, "senderUserId" integer, "replyByUserId" integer, CONSTRAINT "PK_f0aae0d876a96fa1da0a1b97444" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "report_types" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "deadlineMinutes" integer, "responsibleRoles" text, "hashtags" text, CONSTRAINT "UQ_f9bfaf722e6cbd5eb9c6dab6f27" UNIQUE ("code"), CONSTRAINT "PK_cf77ff01fa1da1f9978995e67c3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_company_assignment" ADD CONSTRAINT "FK_f5a9866f1e91d9af66c09d90ba9" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_company_assignment" ADD CONSTRAINT "FK_59bf3315b7ac4d65690b48b3ac2" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_company_assignment" DROP CONSTRAINT "FK_59bf3315b7ac4d65690b48b3ac2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_company_assignment" DROP CONSTRAINT "FK_f5a9866f1e91d9af66c09d90ba9"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."message_logs_replybyroleatmoment_enum"`,
    );
    await queryRunner.query(`DROP TYPE "public"."message_logs_status_enum"`);
    await queryRunner.query(
      `DROP TYPE "public"."message_logs_senderroleatmoment_enum"`,
    );
    await queryRunner.query(

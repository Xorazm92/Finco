...
export class InitialSchema1747513342451 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_chat_roles_role_enum" AS ENUM('CLIENT', 'ACCOUNTANT', 'BANK_CLIENT', 'SUPERVISOR', 'ADMIN', 'DIRECTOR', 'OTHER_INTERNAL')`);
        await queryRunner.query(`CREATE TABLE "user_chat_roles" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "chat_id" bigint NOT NULL, "role" "public"."user_chat_roles_role_enum" NOT NULL DEFAULT 'CLIENT', "assigned_by" bigint, "assigned_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a09624cf71cbb8cb98937ad15fc" PRIMARY KEY ("id"))`);
